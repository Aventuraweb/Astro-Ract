...
const Helados = ({ heroTitle, heroDescription, heroImageSrc }) => {
    ...
    <div className="container mx-auto p-4 md:p-12" >
      <main className="flex flex-col md:flex-row items-center md:text-left" >
        <div className="w-full md:w-1/2 flex flex-col items-start text-left md:ml-20" data-aos="fade out">
          <h1 className=" text-[36px] md:text-[64px] font-bold text-[#00C08B] font-montserrat mb-6 leading-tight whitespace-normal md:whitespace-pre-line">
            {heroTitle}
          </h1>
          <p className=" text-gray-500 mb-4 text-[16px] font-montserrat leading-relaxed  whitespace-normal md:whitespace-pre-line">
            {heroDescription}
          </p>
